...
namespace EasyMLCore.MathTools
{
    ...
    public static class Discrete
    {
        ...
        //Static constructor
        /// <summary>
        /// Static constructor. Prepares internal factorial cache.
        /// </summary>
        static Discrete()
        {
        ...
        public static ulong Factorial(uint n)
        {
            ...
            {
                throw (new ArgumentException($"Argument is bigger than the FactorialMaxArgument {FactorialMaxArgument}", nameof(n)));
            }
        ...
        {
            //Checks
            if (n1 < 1) throw new ArgumentException($"n1={n1} is less than 1", nameof(n1));
            if (n2 < 1) throw new ArgumentException($"n2={n2} is less than 1", nameof(n2));
            while (n2 != 0)
            {
                int tmp = n1;
                n1 = n2;
