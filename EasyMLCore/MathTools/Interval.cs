...
namespace EasyMLCore.MathTools
{
    ...
    /// </summary>
    [Serializable]
    public class Interval : SerializableObject
    {
        //Static members
        /// <summary>
        ...
        /// </summary>
        public static readonly Interval IntZPI = new Interval(0d, double.MaxValue.Bound(), false, true);
        /// <summary>
        /// An interval of range -1...positive infiniti
        /// </summary>
        public static readonly Interval IntN1PI = new Interval(-1d, double.MaxValue.Bound(), false, true);
        /// <summary>
        /// An interval of range negative infiniti...positive infiniti
        /// </summary>
        public static readonly Interval IntNIPI = new Interval(double.MinValue.Bound(), double.MaxValue.Bound(), false, true);
