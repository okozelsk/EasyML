...
{
    /// <summary>
    /// Configuration of the Adamax optimizer (variant of Adam based on the infinity norm).
    /// </summary>
    [Serializable]
    public class AdamaxConfig : ConfigBase, IOptimizerConfig
    {
        //Constants
        /// <summary>
        /// Name of an associated xsd type.
        /// </summary>
        public const string XsdTypeName = "AdamaxConfig";
        //Default values
        /// <summary>
        /// Default value of the parameter specifying the initial learning rate. Default is 2e-3.
        /// </summary>
        public const double DefaultIniLR = 0.002d;
        /// <summary>
        ...
        /// </summary>
        /// <param name="iniLR">Specifies the initial learning rate. Default is 2e-3.</param>
        ...
        public AdamaxConfig(double iniLR = DefaultIniLR,
        ...
        public AdamaxConfig(AdamaxConfig source)
        ...
        public AdamaxConfig(XElement elem)
        {
            //Validation
        ...
        //Properties
        /// <inheritdoc/>
        public Optimizer OptimizerID { get { return Optimizer.Adamax; } }
        /// <summary>
        /// Checks the defaults.
        /// </summary>
        ...
        {
            return GetXml("adamax", suppressDefaults);
        }
